...
class VtbVoiceListBorder:
    ...
    BORDER_SYNTAX_TITLE_L = 50                              # 语法标题左侧留白距离
    BORDER_SYNTAX_EXPLAIN_L = 70                            # 语法内容左侧留白距离
    ...
    BORDER_DESIGNER_RD = 10                                 # 开发者信息的右下留白距离
    BORDER_LD_WATERMARK_TEXT_LD = 20                        # 左下角水印文字左下的留白距离
